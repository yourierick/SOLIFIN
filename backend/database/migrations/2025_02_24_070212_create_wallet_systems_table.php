...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('wallet_system_transactions', function (Blueprint $table) {
            ...
            $table->enum('type', ['sales', 'withdrawal', 'frais de retrait', 'frais de transfert', 'frais d achat', 'commission de retrait', 'commission de parrainage', 'commission de transfert', 'bonus', 'reception', 'transfer']);

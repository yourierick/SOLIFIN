...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    /**
     * Récupère les utilisateurs qui ont l'utilisateur comme parrain
     */
    public function referrals()
    {
        return $this->hasManyThrough(
            User::class,
            UserPack::class,
            'sponsor_id', // Clé étrangère sur la table user_packs
            'id', // Clé locale sur la table users
            'id', // Clé locale sur la table users
            'user_id' // Clé étrangère sur la table user_packs
        );
    }

    /**
     * Récupère le parrain de l'utilisateur
     */
    ...
    /**
     * Récupère le pack de publication de l'utilisateur
     */
    ...
    /**
     * Récupère le nombre de filleuls regroupés par pack
     */
    ...
    /**
     * Récupère la liste des filleuls avec un filtre optionnel sur le pack
     */

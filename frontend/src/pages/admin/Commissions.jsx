                          ...
                          .map((commission) => (
                            ...
                            >
                              ...
                              >
                                {commission.sponsor_user ? (
                                  <Tooltip
                                    title={commission.sponsor_user.email}
                                  >
                                  ...
                                  {commission.status === "failed" && (
                                    <Tooltip title="Relancer la commission">
                                      <IconButton
                                        size="small"
                                        onClick={() =>
                                          handleRetryCommission(commission.id)
                                        }
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                      ...
                      >
                        ...
                        sur {filteredCommissions.length}
                      </Typography>
                            ...
                            <Box sx={{ display: "flex", alignItems: "center" }}>
                              ...
                              {selectedCommission.status === "failed" && (
                                <Button
                                  ...
                                  variant="outlined"
                                  onClick={() =>
                                    handleRetryCommission(selectedCommission.id)
                                  }
                                  disabled={retryLoading}
                                  sx={{ ml: 2 }}
                                >
                  ...
                  <Grid item xs={12} sm={6} md={3}>
                    ...
                    >
                      <CardContent>
                        ...
                        <Typography variant="body2" color="text.secondary">
                          Montant:{" "}
                          {formatAmount(statistics.completed_amount || 0)}
                        </Typography>
                      </CardContent>
                    </Card>
                  </Grid>

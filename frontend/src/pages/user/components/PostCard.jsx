...
export default function PostCard({
  ...
  return (
    <div
      className={`rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl mb-6 ${
        isDarkMode
    ...
    >
          ...
          <div className="flex-shrink-0 group">
            {post.user?.picture_url ? (
              <img
                ...
                className="h-14 w-14 rounded-full object-cover ring-2 ring-primary-500 ring-opacity-50 shadow-md transition-all duration-300 group-hover:ring-primary-400 group-hover:scale-105"
              />
            ) : (
              <div
                className={`h-14 w-14 rounded-full flex items-center justify-center shadow-md transition-all duration-300 group-hover:scale-105 ${
                  isDarkMode
          ...
          <AnimatePresence>
            {isOptionsMenuOpen && (
              <motion.div
                ...
                className={`absolute right-0 mt-2 w-56 rounded-xl overflow-hidden shadow-lg z-10 backdrop-blur-sm ${
                  isDarkMode
      ...
      <div className="px-5 py-4">
        ...
        <div className="flex items-center mb-3">
          <div
            className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getPostTypeBadgeStyles(
              post.type,
              isDarkMode
            )}`}
          >
            {renderTypeIcon()}
            <span className="ml-1.5">{getPostTypeLabel(post.type)}</span>
          </div>
        </div>
        ...
        >
          <div className="first-letter:text-4xl first-letter:font-bold first-letter:mr-1 first-letter:float-left first-letter:leading-tight first-letter:mt-1 first-letter:text-primary-500">
            {post.content}
          </div>
        </div>
            ...
            >
              ...
              {post.user?.phone && (
                <motion.a
                  ...
                  className="absolute top-3 right-3 z-20 bg-green-600 hover:bg-green-700 text-white p-2.5 rounded-full shadow-lg"
              ...
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-3 left-3 backdrop-blur-md bg-black/50 text-white text-xs font-medium px-3 py-1.5 rounded-full z-10 flex items-center space-x-1.5 shadow-lg">
                  {mediaItems[currentMediaIndex]?.type === "image" ? (
                    <>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                      ...
                      <span>
                        Image {currentMediaIndex + 1}/{mediaItems.length}
                      </span>
                    </>
                  ) : (
                    <>
                      ...
                      <span>
                        Vidéo {currentMediaIndex + 1}/{mediaItems.length}
                      </span>
                    </>
                  )}
                </div>
            ...
            {mediaItems.length > 1 && (
              <>
                <motion.button
                  ...
                  className="absolute left-3 top-1/2 transform -translate-y-1/2 backdrop-blur-sm bg-black/40 text-white rounded-full p-2.5 hover:bg-black/60 transition-all z-10 shadow-lg"
                ...
                <motion.button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 backdrop-blur-sm bg-black/40 text-white rounded-full p-2.5 hover:bg-black/60 transition-all z-10 shadow-lg"
                  ...
                  <button
                    ...
                    className={`h-1.5 rounded-full transition-all duration-300 ${
                      index === currentMediaIndex
                        ...
                        : `w-1.5 ${isDarkMode ? "bg-gray-600" : "bg-gray-300"}`
                    }`}
            ...
            >
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className={`w-full py-2.5 px-4 pr-20 rounded-full text-sm shadow-sm ${
                    isDarkMode
                  ...
                  .map((comment, index) => (
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center mt-1.5 text-xs space-x-4 px-2">
                ...
                {post.comments &&
                  visibleCommentsCount < post.comments.length && (
                    <motion.button
                      ...
                      whileTap={{ scale: 0.98 }}
                      className={`mt-4 text-sm font-medium flex items-center justify-center w-full py-2.5 rounded-lg shadow-sm transition-all duration-200 ${
                        isDarkMode

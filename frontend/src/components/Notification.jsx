...
const notify = (message, type, iconName) => {
  ...
  $.notify(
    ...
    },
    {
      ...
      template: `
  <div class="fixed bottom-5 right-5 left-5 sm:left-auto max-w-sm w-auto sm:w-full">
    <div class="flex items-center p-4 ${colors[type].bg} rounded-lg ${colors[type].shadow} w-full">

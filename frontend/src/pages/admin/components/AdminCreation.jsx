...
const AdminCreation = ({
  ...
  return (
    <div className="mt-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4 gap-4">
          <div className="flex-1">
            ...
            <p className="text-gray-600 dark:text-gray-300 text-sm border-l-4 border-blue-500 dark:border-blue-400 pl-3 py-1 bg-blue-50 dark:bg-blue-900/20 rounded-r">
              Créez, modifiez et gérez les accès administrateurs de la plateforme
            </p>
          </div>
          <button
            onClick={openModal}
      ...
      {showModal && (
        <div
          className="fixed inset-0 backdrop-blur-sm flex items-center justify-center z-[9999] animate__animated animate__fadeIn animate__faster overflow-hidden"
          style={{ 
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden animate__animated animate__zoomIn animate__faster relative transform transition-all duration-300 ease-in-out">
            ...
            <div className={`${adminToEdit ? "bg-gradient-to-r from-blue-600 to-blue-800 dark:from-blue-700 dark:to-blue-900" : "bg-gradient-to-r from-green-600 to-green-800 dark:from-green-700 dark:to-green-900"} text-white px-6 py-4`}>
              <div className="flex justify-between items-center">
                <h3 className="text-xl font-bold flex items-center">
                  {adminToEdit ? (
                    <>
                      <PencilSquareIcon className="h-6 w-6 mr-3 filter drop-shadow-md animate__animated animate__fadeIn" />
                      <span className="animate__animated animate__fadeIn">Modifier un administrateur</span>
                    </>
                  ) : (
                    <>
                      <ShieldCheckIcon className="h-6 w-6 mr-3 filter drop-shadow-md animate__animated animate__fadeIn" />
                      <span className="animate__animated animate__fadeIn">Créer un administrateur</span>
                    </>
                  )}
                </h3>
                <button
              ...
              <div className="grid grid-cols-1 gap-5">
                ...
                <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg border border-gray-100 dark:border-gray-700 mb-2">
                  ...
                  <div className="space-y-4">
                    {/* Nom complet */}
                    <div className="animate__animated animate__fadeIn" style={{ animationDelay: '50ms' }}>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg border border-gray-100 dark:border-gray-700 mb-2">
                  ...
                  <div className="space-y-4">
                    {/* Mot de passe */}
                    <div className="animate__animated animate__fadeIn" style={{ animationDelay: '150ms' }}>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Mot de passe {!adminToEdit && <span className="text-red-500">*</span>}
                        {adminToEdit && <span className="text-xs text-gray-500 dark:text-gray-400 ml-1">(laisser vide pour ne pas modifier)</span>}
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor">
                        ...
                        <input
                          ...
                          placeholder={adminToEdit ? "••••••••" : "Minimum 8 caractères"}
                          className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-800 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-200"
                        />
                      </div>
                    </div>
                    ...
                    <div className="animate__animated animate__fadeIn" style={{ animationDelay: '200ms' }}>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Confirmer le mot de passe {!adminToEdit && <span className="text-red-500">*</span>}
                        {adminToEdit && <span className="text-xs text-gray-500 dark:text-gray-400 ml-1">(laisser vide pour ne pas modifier)</span>}
                      </label>
                      <div className="relative">
                        <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        ...
                        <input
                          ...
                          required={!adminToEdit}
                          minLength={adminToEdit ? 0 : 8}
                          placeholder={adminToEdit ? "••••••••" : "Confirmez le mot de passe"}
                          className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-800 dark:text-white focus:ring-2 focus:ring-blue-500 dark:focus:ring-blue-400 focus:border-transparent transition-all duration-200"
                        />
                      </div>
                    </div>
                ...
                <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg border border-gray-100 dark:border-gray-700 mb-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Téléphone */}
                      <div className="animate__animated animate__fadeIn" style={{ animationDelay: '250ms' }}>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                          Téléphone
                        </label>
                        <div className="relative">
                    ...
                    {/* Adresse */}
                    <div className="animate__animated animate__fadeIn" style={{ animationDelay: '350ms' }}>
                      <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                        Adresse
                      </label>
                      <div className="relative">
                    ...
                    {/* Localisation */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate__animated animate__fadeIn" style={{ animationDelay: '400ms' }}>
                      {/* Pays */}
                      <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                          Pays
                ...
                {/* Rôle - Section */}
                <div className="bg-gray-50 dark:bg-gray-700/30 p-4 rounded-lg border border-gray-100 dark:border-gray-700 mb-2 animate__animated animate__fadeIn" style={{ animationDelay: '450ms' }}>
                  <h4 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3 flex items-center">
                ...
                <div className="flex justify-end mt-6 space-x-3 animate__animated animate__fadeIn" style={{ animationDelay: '500ms' }}>
                  <button
                    type="button"
                    onClick={() => setShowModal(false)}
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`px-5 py-2.5 text-white rounded-lg transition-all duration-300 font-medium flex items-center shadow-md hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-opacity-50 transform hover:scale-105 hover:-translate-y-1 ${adminToEdit ? 'bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 focus:ring-blue-500' : 'bg-gradient-to-r from-green-600 to-green-700 hover:from-green-700 hover:to-green-800 focus:ring-green-500'}`}
                  ...
                  >
                    {loading ? (
                      <>
                        ...
                        <span className="animate__animated animate__fadeIn animate__infinite animate__slow">Traitement en cours...</span>
                      </>
                    ) : adminToEdit ? (
                      <>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1.5" viewBox="0 0 20 20" fill="currentColor">
                      ...
                      <>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-1.5" viewBox="0 0 20 20" fill="currentColor">
                          <path fillRule="evenodd" d="M10 3a1 1 0 011 1v5h5a1 1 0 110 2h-5v5a1 1 0 01-1 1h-5a1 1 0 01-1-1v-5H2a1 1 0 010-2h5V4a1 1 0 011-1z" clipRule="evenodd" />
                        </svg>
                        Créer
                      </>
                    )}

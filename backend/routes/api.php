...
// Route publique pour la configuration des devises (accessible sans authentification)
Route::get('/settings/dual_currency', function() {
    return app(\App\Http\Controllers\Admin\SettingsController::class)->getByKey('dual_currency');
});
...
Route::middleware(['auth:sanctum', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::middleware('permission:manage-users')->group(function () {
        ...
        Route::get('users/dashboard-stats', [UserController::class, 'getDashboardStats']);

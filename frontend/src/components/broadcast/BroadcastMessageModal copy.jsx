            ...
            >
              ...
              <Box
                sx={{
                  ...
                  maxHeight: "50vh", // Limite la hauteur des images pour éviter qu'elles ne prennent tout l'espace
                }}
              >
                <img
              ...
              <Box
                sx={{
                  ...
                  boxShadow: isDarkMode
                    ? "0 8px 16px rgba(0, 0, 0, 0.5)"
                    : "0 8px 16px rgba(0, 0, 0, 0.1)",
                  maxHeight: "50vh", // Limite la hauteur des vidéos
                }}
              >
                <video
                  controls
              ...
              >
                <Typography
                  ...
                  sx={{
                    mb: 2,
                    textAlign: "center",
                    width: "90%", // Utilise width au lieu de maxWidth pour une meilleure cohérence
                    lineHeight: 1.8,
                    fontSize: "1.1rem",
                    px: 3,
                    py: 2,
                    ...
                    boxShadow: isDarkMode
                      ? "0 4px 6px -1px rgba(0, 0, 0, 0.2)"
                      : "0 4px 6px -1px rgba(0, 0, 0, 0.1)",
                    overflowWrap: "break-word", // Assure que le texte long se brise correctement
  ...
  return (
    ...
    >
      ...
      <DialogContent sx={{ 
        ...
        pb: 3, 
        px: isMobile ? 2 : 4,
        maxHeight: "80vh", // Limite la hauteur maximale à 80% de la hauteur de la fenêtre
        overflow: "auto", // Ajoute un ascenseur automatique si nécessaire
        scrollbarWidth: "thin", // Pour Firefox
        "&::-webkit-scrollbar": { // Pour Chrome, Safari, etc.
          width: "8px",
        ...
        >
          ...
          <Button
            ...
            color={currentIndex < messages.length - 1 ? "inherit" : "primary"}
            sx={{
              color:
                currentIndex < messages.length - 1
                  ? isDarkMode

...
const DigitalProductCard = ({
  ...
  const defaultImage = "https://placehold.co/300x200/e2e8f0/475569?text=Produit+Numérique";
  ...
  const getProductIcon = () => {
    switch (product.type) {
      ...
      case "office_tools":
        return <ArchiveBoxIcon className={`h-8 w-8 ${iconColor}`} />;
      default:
        return <DocumentTextIcon className={`h-8 w-8 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`} />;
    }
  };
  ...
  return (
    <div className={`${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-900'} rounded-lg shadow-md overflow-hidden transition-colors duration-200`}>
      {/* Image du produit */}
      ...
      <div className="p-4">
        ...
        <div className="mt-2">
          <p className={`text-sm ${isDarkMode ? 'text-gray-300' : 'text-gray-600'} line-clamp-2 overflow-hidden`} 
        ...
        <div className="mt-4 flex justify-between items-center">
          ...
          <div className={`text-xs ${isDarkMode ? 'text-gray-300' : 'text-gray-500'} flex items-center`}>
        ...
        {product.raison_rejet && (
          <div className={`mt-2 p-2 ${isDarkMode ? 'bg-red-900/30 text-red-300' : 'bg-red-50 text-red-700'} rounded text-sm`}>
            ...
            <div className="flex space-x-2">
              ...
              <div className="group relative">
                <button
                  ...
                  className={`p-2 rounded-full shadow-sm ${isDarkMode ? 'bg-blue-600 hover:bg-blue-700 text-white' : 'bg-blue-100 hover:bg-blue-200 text-blue-600'} transition-colors duration-200`}
              ...
              {onEdit && (
                <div className="group relative">
                  <button
                    ...
                    className={`p-2 rounded-full shadow-sm ${isDarkMode ? 'bg-gray-700 hover:bg-gray-600 text-gray-200' : 'bg-gray-100 hover:bg-gray-200 text-gray-600'} transition-colors duration-200`}
                    aria-label="Modifier"
                  >
              ...
              {onDelete && (
                <div className="group relative">
                  <button
                    ...
                    className={`p-2 rounded-full shadow-sm ${isDarkMode ? 'bg-red-600 hover:bg-red-700 text-white' : 'bg-red-100 hover:bg-red-200 text-red-600'} transition-colors duration-200`}
